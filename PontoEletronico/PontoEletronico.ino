...
const char* ssid = "Vini";  //--> Your wifi name
const char* password = "vini1406"; //--> Your wifi password
//----------------------------------------

// Google script Web_App_URL.
String Web_App_URL = "https://script.google.com/macros/s/AKfycbxDOHWq6xpL63vvnIXc_21K3Koss567lJJaj69XCuRE6Tp_mpjsdWhfdrUFfBQZwg/exec";
...
void loop(){
  ...
  if (modes == "atc") {
    lcd.setCursor(2,0);
    lcd.print("PONTO ELETRONICO");
    lcd.setCursor(0,1);
    lcd.print("");
    lcd.setCursor(0,2);
    lcd.print("- Use o cartao para");
    lcd.setCursor(1,3);
    lcd.print("registrar o ponto -");
